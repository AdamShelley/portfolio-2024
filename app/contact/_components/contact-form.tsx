  ...
  return (
    ...
    >
      ...
      <input
        ...
        type="email"
        name="email"
        className="mt-1 p-2 w-full rounded border border-gray-400 bg-gray-900/30"
      />
      <ValidationError
        prefix="Email"
        field="email"
      ...
      <textarea
        id="message"
        name="message"
        className="mt-1 p-2 w-full h-40 rounded border border-gray-400 resize-none bg-gray-900/30"
      />
