...
### Challenge
![Breathe Screenshot 1](/assets/Breathe/breathe-code1.png)

The Raycast API is quite strict on the way to build components, you are limited to things like lists and markdown text. 
Make something appear dynamic or interactive is a bit of a challenge. You have to get a bit creative with the special characters and emojis.
