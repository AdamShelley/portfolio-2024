          ...
          <div className="flex flex-wrap items-center justify-start w-full pt-1 z-10 -ml-1">
            {skills &&
              skills.map((skill, index) => (
                <Badge
                  key={index}
                  className="mr-2 mt-2 min-w-[50px] text-[10px] font-normal bg-zinc-500 text-zinc-100 dark:bg-teal-600/10 dark:text-teal-300/90 dark:border-teal-700 rounded-xs"
                >
                  {skill}
                </Badge>
              ))}
