...
const projects = [
  ...
  },
  {
    project: {
      name: "breathe",
      filename: "breathe",
      skills: ["React", "Typescript", "Raycast"],
      description:
  ...
  // },
  {
    project: {
      name: "langAI",
      filename: "lang-ai",
      skills: ["React Native", "Node.js", "Supabase", "ChatGPT"],
      description:
...
const Separator = ({
  ...
  const baseClasses = "flex items-center my-2";
...
const ProjectList = () => {
  return (
    <section className="grid md:grid-cols-1 items-center gap-6 lg:mt-0 orchestration">
      {projects
        .filter((item) => {
