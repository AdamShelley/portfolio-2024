...
This was my first time working with Tauri, which recently released version 2. I have also never used Rust before, 
so it was a steep learning curve. This is where using AI can shine, since I know Javascript/Typescript I am able to use AI like Claude 
...
- Can summarise an issue into a changelog using Anthropics AI **[Claude](https://claude.ai/)**.
- Download the info to a .md file.




<ClickableImage src='/assets/GitPulse/gitpulse3.png' alt="app-screenshot-1"  width={500} height={1590} />
