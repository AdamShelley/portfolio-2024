---
title: 'Breathe'
summary: 'A Raycast extension to help you take a moment to breathe.'
published: 'true'
---
...
<ClickableImage src='/assets/Breathe/breathe1.png' alt="app-screenshot-1" caption="A simple interface" width={2248} height={1590} />

##  Challenge

<ClickableImage src='/assets/Breathe/breathe-code1.png' alt="app-screenshot-1"  caption="Raycast In-built components" width={2248} height={1590} />
...
<ClickableImage src='/assets/Breathe/breathe2.png' alt="app-screenshot-1" caption="A moment of calm" width={2248} height={1590} />

<ClickableImage src='/assets/Breathe/breathe3.png' alt="app-screenshot-1"  width={2248} height={1590}  caption="Another example of a breathing exercise"/>

### Download
You can clone the repo at my Github below. 
